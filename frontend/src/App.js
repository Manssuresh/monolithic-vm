...
const StudentTable = () => {
  ...
  useEffect(() => {
    axios.get('http://backend url/studentlist')
      .then(response => {
    ...
    axios.get('http://backend url/employeelist')
      .then(response => {
    ...
    axios.get('http://backend url/workerlist')
      .then(response => {
    ...
    axios.get('http://backend url/salarylist')
      .then(response => {
